...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">deepakgogula03@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Deepak.jpg" width=120 height=175 alt="GOGULA DEEPAK" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">GOGULA DEEPAK</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8143245010</h4>
		<h4 style="font-family:'typo' ">deepakgogula03@gmail.com</h4>
		<h4 style="font-family:'typo' ">Sagi Rama Krishnam Raju Engineering College Bhimavaram</h4></div></div>
		</p>
      </div>
